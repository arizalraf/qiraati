                ...
                <Card>
                    <CardHeader>
                        <Link href="/" className="text-4xl font-black leading-relaxed tracking-tighter">
                            Qiraati<span className="text-red-500">.</span>
                        </Link>
                            ...
                            <form className="space-y-6" onSubmit={submit}>
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        onErrors={errors.name && <InputError message={errors.name} className="mt-1" />}
                                    />
                                </div>
                                <div>
...
Register.layot = (page) => <GuestLayout children={page} title="Register" />;
